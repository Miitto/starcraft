...
import net.mod.starcraft.procedures.OpenEnegiserGUIProcedure;
import net.mod.starcraft.procedures.EnegiserUpdateTickProcedure;
...
public class EnegiserBlock extends ScModElements.ModElement {
	@ObjectHolder("sc:enegiser")
	public static final Block block = null;
	@ObjectHolder("sc:enegiser")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public EnegiserBlock(ScModElements instance) {
		super(instance, 26);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("enegiser"));
	}
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Charges up items"));
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				EnegiserUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				OpenEnegiserGUIProcedure.executeProcedure($_dependencies);
			}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("enegiser");
		}
