...
import net.mod.starcraft.block.PuttyBlock;
...
public class AlienWorldDimension extends ScModElements.ModElement {
	@ObjectHolder("sc:alien_world")
	public static final ModDimension dimension = null;
	@ObjectHolder("sc:alien_world_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public AlienWorldDimension(ScModElements instance) {
		super(instance, 30);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("alien_world"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("sc:alien_world")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("sc:alien_world"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("sc:alien_world"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("sc:alien_grasslands")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("sc:alien_woodland")),};
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new CustomPortalBlock());
		elements.items.add(() -> new AlienWorldItem().setRegistryName("alien_world"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("alien_world_portal");
		}
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = AlienWorldDimension.CustomPortalBlock.createPatternHelper(entity.world, new BlockPos(pos));
	...
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "alien_world_portal",
	...
	public static class TeleporterDimensionMod extends Teleporter {
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = AlienWorldDimension.CustomPortalBlock.createPatternHelper(this.world,
						blockpos);
		...
		public ChunkProviderModded(IWorld world, BiomeProvider provider) {
			super(world, provider, new OverworldGenSettings() {
				...
				public BlockState getDefaultFluid() {
					return PuttyBlock.block.getDefaultState();
				}
			});
