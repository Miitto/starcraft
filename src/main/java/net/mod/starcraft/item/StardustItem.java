...
public class StardustItem extends ScModElements.ModElement {
	@ObjectHolder("sc:stardust")
	public static final Item block = null;
	public StardustItem(ScModElements instance) {
		super(instance, 1);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Mysterious Dust...."));
		}
