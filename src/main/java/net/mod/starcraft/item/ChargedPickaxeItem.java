...
public class ChargedPickaxeItem extends ScModElements.ModElement {
	@ObjectHolder("sc:charged_pickaxe")
	public static final Item block = null;
	public ChargedPickaxeItem(ScModElements instance) {
		super(instance, 14);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("charged_pickaxe"));
	}
}
