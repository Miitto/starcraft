...
public class ChargedAsteroidIngotItem extends ScModElements.ModElement {
	@ObjectHolder("sc:charged_asteroid_ingot")
	public static final Item block = null;
	public ChargedAsteroidIngotItem(ScModElements instance) {
		super(instance, 4);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("charged_asteroid_ingot");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("This item seems to be brimming with energy"));
		}
