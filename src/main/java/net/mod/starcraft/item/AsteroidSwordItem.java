...
public class AsteroidSwordItem extends ScModElements.ModElement {
	@ObjectHolder("sc:asteroid_sword")
	public static final Item block = null;
	public AsteroidSwordItem(ScModElements instance) {
		super(instance, 11);
	}
	...
	public void initElements() {
		...
		}, 3, -2f, new Item.Properties().group(StarcraftToolsItemGroup.tab)) {
			@Override
		...
		}.setRegistryName("asteroid_sword"));
	}
}
