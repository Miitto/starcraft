...
public class AsteroidAxeItem extends ScModElements.ModElement {
	@ObjectHolder("sc:asteroid_axe")
	public static final Item block = null;
	public AsteroidAxeItem(ScModElements instance) {
		super(instance, 10);
	}
