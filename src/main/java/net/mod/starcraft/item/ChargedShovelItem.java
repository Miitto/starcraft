...
public class ChargedShovelItem extends ScModElements.ModElement {
	@ObjectHolder("sc:charged_shovel")
	public static final Item block = null;
	public ChargedShovelItem(ScModElements instance) {
		super(instance, 17);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ShovelItem(new IItemTier() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(Items.DIAMOND, (int) (1)), new ItemStack(ChargedAsteroidIngotItem.block, (int) (1)));
			}
		...
		}.setRegistryName("charged_shovel"));
	}
}
