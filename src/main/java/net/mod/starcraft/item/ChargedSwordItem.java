...
public class ChargedSwordItem extends ScModElements.ModElement {
	@ObjectHolder("sc:charged_sword")
	public static final Item block = null;
	public ChargedSwordItem(ScModElements instance) {
		super(instance, 16);
	}
	...
	public void initElements() {
		...
		}, 3, -3f, new Item.Properties().group(StarcraftToolsItemGroup.tab)) {
			@Override
