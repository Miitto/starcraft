...
public class WeirdDiamondItem extends ScModElements.ModElement {
	@ObjectHolder("sc:weird_diamond")
	public static final Item block = null;
	public WeirdDiamondItem(ScModElements instance) {
		super(instance, 8);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Vibin..."));
		}
	}
}
